...
var messagesResource = schema.GroupVersionResource{Group: "messenger.kubeware.io", Version: "v1alpha1", Resource: "messages"}

var messagesKind = schema.GroupVersionKind{Group: "messenger.kubeware.io", Version: "v1alpha1", Kind: "Message"}
