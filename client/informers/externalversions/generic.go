...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("messages"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Messenger().V1alpha1().Messages().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("messagingservices"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Messenger().V1alpha1().MessagingServices().Informer()}, nil
