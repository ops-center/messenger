...
func NewForConfig(c *rest.Config) (*MessengerV1alpha1Client, error) {
	...
	return &MessengerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new MessengerV1alpha1Client for the given config and
...
func New(c rest.Interface) *MessengerV1alpha1Client {
	return &MessengerV1alpha1Client{c}
}
