...
import (
	...
	"github.com/kubeware/messenger/pkg/cmds"
...
menu:
  product_messenger_{{ .Version }}:
    identifier: reference
    name: Reference
    weight: 1000
menu_name: product_messenger_{{ .Version }}
---
`))
...
{{- if .RootCmd }}
aliases:
  - products/messenger/{{ .Version }}/reference/
{{ end }}
---
`))
)
...
func main() {
	...
	dir := runtime.GOPath() + "/src/github.com/kubeware/messenger/docs/reference"
