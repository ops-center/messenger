...
func (p MessagingService) CustomResourceDefinition() *crd_api.CustomResourceDefinition {
	return crdutils.NewCustomResourceDefinition(crdutils.Config{
		...
		SpecDefinitionName:    "github.com/kubeware/messenger/apis/messenger/v1alpha1.MessagingService",
...
func (p Message) CustomResourceDefinition() *crd_api.CustomResourceDefinition {
	return crdutils.NewCustomResourceDefinition(crdutils.Config{
		...
		SpecDefinitionName:    "github.com/kubeware/messenger/apis/messenger/v1alpha1.Message",
		EnableValidation:      true,
		GetOpenAPIDefinitions: GetOpenAPIDefinitions,
	})
}
