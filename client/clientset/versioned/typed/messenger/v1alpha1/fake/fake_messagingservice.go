...
var messagingservicesResource = schema.GroupVersionResource{Group: "messenger.appscode.com", Version: "v1alpha1", Resource: "messagingservices"}

var messagingservicesKind = schema.GroupVersionKind{Group: "messenger.appscode.com", Version: "v1alpha1", Kind: "MessagingService"}
...
func (c *FakeMessagingServices) List(opts v1.ListOptions) (result *v1alpha1.MessagingServiceList, err error) {
	...
	list := &v1alpha1.MessagingServiceList{}
